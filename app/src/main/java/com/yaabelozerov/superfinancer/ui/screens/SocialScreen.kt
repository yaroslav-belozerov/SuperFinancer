...
@Composable
fun SocialScreen(addToPostArticleUrl: String?, navigator: DestinationsNavigator) = FeedScreen(addToPostArticleUrl, onAdd = {
    navigator.navigate(SocialScreenDestination(null)) {
